...
def fetch_and_save_data():
    ...
    channels = [
        ...
        {"handle": "@유노-Yuno","category": "Food"},
        {"handle": "@TryToEat", "category": "Food"},
        {"handle": "@ITSUB", "category": "tech"},
        {"handle": "@techmong", "category": "tech"},
        {"handle": "@OMG_electronics", "category": "tech"},
        {"handle": "@zuyoni1", "category": "tech"}
    ]
